...
class TwitterbombCampaign extends XoopsObject
{
    public function __construct($fid = null)
    {
        ...
        $this->initVar('type', XOBJ_DTYPE_ENUM, 'bomb', true, false, false, ['bomb', 'scheduler', 'retweet', 'reply', 'mention']);
...
class TwitterbombCampaignHandler extends XoopsPersistableObjectHandler
{
    ...
    public function getFilterForm($filter, $field, $sort = 'created', $op = 'campaign', $fct = 'list')
    {
