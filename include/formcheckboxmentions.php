...
class TwitterbombFormCheckBoxMentions extends XoopsFormElement
{
    /**
     * Availlable options
     *
     ...
     */
    public function TwitterbombFormCheckBoxMentions($caption, $name, $value = null, $delimeter = '&nbsp;')
    {
        ...
        foreach ($mentions_handler->getObjects($criteria, true) as $mid => $mentions) {
            $this->addOption($mid, $mentions->getVar('user'));
        }
    }
