...
class TwitterBombFormSelectOAuthMode extends XoopsFormElement
{
     ...
     */
    public function TwitterBombFormSelectOAuthMode($caption, $name, $value = null, $size = 1, $multiple = false, $blank = true)
    {
        ...
        foreach (['valid', 'invalid', 'expired', 'disabled', 'other'] as $mode) {
